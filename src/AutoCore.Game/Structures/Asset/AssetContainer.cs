...
namespace AutoCore.Game.Structures.Asset
{
    ...
    public class AssetContainer
    {
        ...
        /*public MapEntry GetMapEntryById(uint continentId)
        {
            ...
            if (!_mapNameLookup.TryGetValue(continentId, out string s))
                return null;
        ...
        /*public MapEntry GetMapEntryByName(string name)
        {
            ...
            me = MapEntries.TryGetValue(name, out MapEntry me) ? me : null;
        ...
        public ConfigNewCharacter GetNewCharacterDataByRaceClass(byte race, byte c)
        {
            ...
            var ret = ConfigNewCharacters.TryGetValue(race, out IList<ConfigNewCharacter> l) ? l.SingleOrDefault(e => e.Class == c) : null;
