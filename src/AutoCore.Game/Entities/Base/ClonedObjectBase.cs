...
namespace AutoCore.Game.Entities.Base
{
    ...
    public abstract partial class ClonedObjectBase
    {
        ...
        {
            return CloneBaseObject.Type switch
            {
                ObjectType.PowerPlant or ObjectType.Weapon or ObjectType.Vehicle or ObjectType.WheelSet or ObjectType.Armor => true,
                ObjectType.Item => CloneBaseObject.SimpleObjectSpecific.SubType == 10 || CloneBaseObject.SimpleObjectSpecific.SubType == 11,
                _ => false,
            };
        }
