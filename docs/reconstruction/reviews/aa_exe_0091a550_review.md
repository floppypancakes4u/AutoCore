# Review: Input_TryFireSecondaryWeapons (aa_exe_0091a550)
...
- Compared `reconstructed-exact` against `raw/aa_exe_0091a550.md` (or session decompile).
...
- Callers/callees agree with system doc `systems/actions-weapons.md`.
