# Review: Client_SendInventoryGrab_FromGrid (aa_exe_00860e20)
...
- Compared `reconstructed-exact` against `raw/aa_exe_00860e20.md` (or session decompile).
...
- Callers/callees agree with system doc `systems/inventory.md`.
