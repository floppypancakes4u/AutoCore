# Function: Client_RecvInventoryAddItem
...
| Address | `0x008151a0` |
| Original decompiler name | `Client_RecvInventoryAddItem` |
...
S2C add-item / loot notification and place.

## Behavioral summary

Resolve TFID; optional 'Received Loot' chat; place into cargo.

## Signatures

- **Original / decompiler:** see `raw/aa_exe_008151a0.md`
- **Reconstructed:** see `reconstructed-exact/Client_RecvInventoryAddItem.cpp` (or nearest)
...
See `reviews/aa_exe_008151a0_review.md`.
