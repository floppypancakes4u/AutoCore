# Function: ClientSpecialEvent_Respawn_Update
...
| Address | `0x00979730` |
| Original decompiler name | `ClientSpecialEvent_Respawn_Update` |
...
Per-frame INC airlift animation state machine.

## Behavioral summary

Phases 0..7; cptest.geo ship; TeleportTarget at phase 3.

## Signatures

- **Original / decompiler:** see `raw/aa_exe_00979730.md`
- **Reconstructed:** see `reconstructed-exact/ClientSpecialEvent_Respawn_Update.cpp` (or nearest)
...
See `reviews/aa_exe_00979730_review.md`.
