# Function: Client_RecvSpecialEvent
...
| Address | `0x0080cc50` |
| Original decompiler name | `Client_RecvSpecialEvent` |
...
Dispatch S2C SpecialEvent presentation objects.

## Behavioral summary

TFID match to local character; types Respawn/TeleportOut/TeleportIn.

## Signatures

- **Original / decompiler:** see `raw/aa_exe_0080cc50.md`
- **Reconstructed:** see `reconstructed-exact/Client_RecvSpecialEvent.cpp` (or nearest)
...
See `reviews/aa_exe_0080cc50_review.md`.
