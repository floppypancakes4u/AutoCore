# Function: Client_QuickBar_ActivateSlot
...
| Address | `0x009436c0` |
| Original decompiler name | `Client_QuickBar_ActivateSlot` |
...
Activate QB skill/item/power or on-foot fire.

## Behavioral summary

index=slot+page*10; types 1/2/5.

## Signatures

- **Original / decompiler:** see `raw/aa_exe_009436c0.md`
- **Reconstructed:** see `reconstructed-exact/Client_QuickBar_ActivateSlot.cpp` (or nearest)
...
See `reviews/aa_exe_009436c0_review.md`.
